...
import writer as wf
import writer.ai
from charts import handle_click, update_scatter_chart
from dotenv import load_dotenv
from prompts import earnings_prompt, income_prompts, stock_prompts
...
def handle_prompt_parameters_lang(state):
...
def generate_stock_analysis(state):
    ...
    state["message"] = (
        f"% {state['symbol']} trends will be analyzed here in {state['prompt_parameters_lang']}"
    )
...
initial_state = wf.init_state(
    {
        ...
        "show_analysis_text": {"visible": False, "language": False},
        "show_income_metrics": {
            "visible": False,
        },
